...
const Watch = () => {
  ...
  const sendMessage = () => {
    dispatch(setMessage({name:"AbhiD", message:input}));
    setInput("");
  }
      ...
      <div className="flex w-[88%]">
        <div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center w-[47%] justify-between mt-2">
        ...
        <div className="w-[100%] border border-gray-300 ml-8 rounded-lg h-fit p-4">
          ...
          <div className=" flex items-center justify-between border-t p-2">
            <div className="flex items-center w-[90%] ">
              ...
              <input value={input} onChange={(e)=>setInput(e.target.value)} className="border-b border-b-gray-300 outline-none ml-2" type="text" placeholder="Chat...."></input>
